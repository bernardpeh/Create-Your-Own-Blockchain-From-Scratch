...
If participants get stuck, they can checkout the answers from various chapters under the src dir so as to keep the course moving. This is a hands-on course. The best way to learn is to experiment it and make mistakes. Participants are strongly encouraged not to look at the answers unless necessary.

## The Challenge

In the year 2022, your company decided to pay all employees using the company's own Cryptocurrency called "mycoin".

You have been tasked to create a proof of concept in NodeJS using the Bitcoin's model. You are not to take shortcuts by forking Bitcoin or use any platforms like Ethereum, EOS, NEM or NEO to create the coin. Instead, you will need to create one from scratch. It doesn't have to be 100% working. You just need to focus on proofing the concept rather than the syntax.
...
* To build a strong foundation in participants to take on more complex Ethereum and Hyperledger development projects.
